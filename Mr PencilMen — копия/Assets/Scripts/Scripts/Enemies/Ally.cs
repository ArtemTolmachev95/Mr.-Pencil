...
public class Ally : MonoBehaviour
{
	...
	public float life = 10; // жизни врага

	private bool facingRight = true; // смотреть прямо

	public float speed = 5f; // скорость

	public bool isInvincible = false;
	private bool isHitted = false; // поражение 

	[SerializeField] private float m_DashForce = 25f; // сила удара
	...
	public void Jump()
	{
		...
		{
			anim.SetBool("IsWaiting", false);
			m_Rigidbody2D.AddForce(new Vector2(0f, 1000f));
